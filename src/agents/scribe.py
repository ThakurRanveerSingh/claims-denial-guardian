...
# retries before doing any real work — confirmed the single biggest
# contributor to every live command in this project looking hung.
# `setdefault` so an operator who explicitly wants telemetry back on (a
# real `.env` value) isn't overridden.
